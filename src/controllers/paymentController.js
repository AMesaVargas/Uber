...
export const usePaymentController = () => {
  ...
  const processPaymentController = useCallback(async (formData, amount, tripDetails = {}) => {
    setLoading(true);
    ...
    const result = await processPayment(formData.paymentMethod, amount, tripDetails);
